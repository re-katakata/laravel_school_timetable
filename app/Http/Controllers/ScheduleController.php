...
class ScheduleController extends Controller
{
    public function showIndex(Schedule $schedule)
    {
        ...
        $mondaySchedules = $schedule->getMondaySchedules($term_number);
        $mondayArray=[];
    ...
    //火曜日の表示用配列生成
        $tuesdaySchedules = $schedule->getTuesdaySchedules($term_number);
        $tuesdayArray=[];
     ...
     //水曜日の表示用配列生成
        $wednesdaySchedules = $schedule->getWednesdaySchedules($term_number);
        $wednesdayArray=[];
     ...
     //木曜日の表示用配列生成
        $thursdaySchedules = $schedule->getThursdaySchedules($term_number);
        $thursdayArray=[];
     ...
     //金曜日の表示用配列生成
        $fridaySchedules = $schedule->getFridaySchedules($term_number);
        $fridayArray=[];
     ...
     //土曜日の表示用配列生成
        $saturdaySchedules = $schedule->getSaturdaySchedules($term_number);
        $saturdayArray=[];
     ...
     //日曜日の表示用配列生成
        $sundaySchedules = $schedule->getSundaySchedules($term_number);
        $sundayArray=[];
...
<div class="monday">
    <div class="classes">
        @foreach($monday_schedules as $monday_schedule)
        <div class="schedule">
            //ピリオドナンバーと一致するか？
            @if()
            @endif
